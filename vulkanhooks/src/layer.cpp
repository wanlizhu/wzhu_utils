...
static inline void record_ns(StatId id, uint64_t dt_ns) {
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkCreateSwapchainKHR(VkDevice device,
...
static VKAPI_ATTR void VKAPI_CALL IMPL_vkDestroySwapchainKHR(VkDevice device, VkSwapchainKHR swapchain,
                                                             const VkAllocationCallbacks* pAllocator) {
    auto* d = get_device_dispatch(device);
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkGetSwapchainImagesKHR(VkDevice device, VkSwapchainKHR swapchain,
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkAcquireNextImageKHR(VkDevice device, VkSwapchainKHR swapchain,
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkAcquireNextImage2KHR(VkDevice device,
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkQueuePresentKHR(VkQueue queue, const VkPresentInfoKHR* pPresentInfo) {
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkQueueSubmit(VkQueue queue, uint32_t submitCount,
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkQueueSubmit2(VkQueue queue, uint32_t submitCount,
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkQueueBindSparse(VkQueue queue, uint32_t bindInfoCount,
...
static VKAPI_ATTR void VKAPI_CALL IMPL_vkGetDeviceQueue(VkDevice device, uint32_t queueFamilyIndex,
...
static VKAPI_ATTR void VKAPI_CALL IMPL_vkGetDeviceQueue2(VkDevice device, const VkDeviceQueueInfo2* pQueueInfo,
                                                         VkQueue* pQueue) {
    auto* d = get_device_dispatch(device);
...
#define WZHU_INTERCEPT_INSTANCE_RESULT(Suffix, Member, stat, Args, call)                        \
    static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vk##Suffix Args {                                \
...
#define WZHU_INTERCEPT_INSTANCE_VOID(Name, stat, Args, call)                                    \
    static VKAPI_ATTR void VKAPI_CALL IMPL_vk##Name Args {                                      \
        auto* ex = get_instance_extras(Instance);                                               \
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkCreateInstance(const VkInstanceCreateInfo* pCreateInfo,
                                                            const VkAllocationCallbacks* pAllocator,
...
static VKAPI_ATTR void VKAPI_CALL IMPL_vkDestroyInstance(VkInstance instance,
                                                         const VkAllocationCallbacks* pAllocator) {
...
static VKAPI_ATTR VkResult VKAPI_CALL IMPL_vkCreateDevice(VkPhysicalDevice physicalDevice,
...
static VKAPI_ATTR void VKAPI_CALL IMPL_vkDestroyDevice(VkDevice device, const VkAllocationCallbacks* pAllocator) {
    auto* d = get_device_dispatch(device);
...
static VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL IMPL_vkGetDeviceProcAddr(VkDevice device, const char* pName);

static VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL IMPL_vkGetInstanceProcAddr(VkInstance instance,
                                                                           const char* pName) {
...
#define WZHU_IF_NAME(name, fn) \
    ...
    WZHU_IF_NAME("vkCreateInstance", IMPL_vkCreateInstance);
    WZHU_IF_NAME("vkDestroyInstance", IMPL_vkDestroyInstance);
    WZHU_IF_NAME("vkCreateDevice", IMPL_vkCreateDevice);
    WZHU_IF_NAME("vkDestroyDevice", IMPL_vkDestroyDevice);
    WZHU_IF_NAME("vkGetInstanceProcAddr", IMPL_vkGetInstanceProcAddr);
    WZHU_IF_NAME("vkGetDeviceProcAddr", IMPL_vkGetDeviceProcAddr);

    WZHU_IF_NAME("vkGetPhysicalDeviceSurfaceCapabilitiesKHR", IMPL_vkGetPhysicalDeviceSurfaceCapabilitiesKHR);
    WZHU_IF_NAME("vkGetPhysicalDeviceSurfaceFormatsKHR", IMPL_vkGetPhysicalDeviceSurfaceFormatsKHR);
    WZHU_IF_NAME("vkGetPhysicalDeviceSurfacePresentModesKHR", IMPL_vkGetPhysicalDeviceSurfacePresentModesKHR);
    WZHU_IF_NAME("vkGetPhysicalDeviceSurfaceSupportKHR", IMPL_vkGetPhysicalDeviceSurfaceSupportKHR);

#if defined(VK_USE_PLATFORM_XCB_KHR)
    WZHU_IF_NAME("vkCreateXcbSurfaceKHR", IMPL_vkCreateXcbSurfaceKHR);
#endif
#if defined(VK_USE_PLATFORM_XLIB_KHR)
    WZHU_IF_NAME("vkCreateXlibSurfaceKHR", IMPL_vkCreateXlibSurfaceKHR);
#endif
#if defined(VK_USE_PLATFORM_WAYLAND_KHR)
    WZHU_IF_NAME("vkCreateWaylandSurfaceKHR", IMPL_vkCreateWaylandSurfaceKHR);
#endif
#if defined(VK_USE_PLATFORM_WIN32_KHR)
    WZHU_IF_NAME("vkCreateWin32SurfaceKHR", IMPL_vkCreateWin32SurfaceKHR);
#endif
    WZHU_IF_NAME("vkCreateDisplayPlaneSurfaceKHR", IMPL_vkCreateDisplayPlaneSurfaceKHR);
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
    WZHU_IF_NAME("vkCreateAndroidSurfaceKHR", IMPL_vkCreateAndroidSurfaceKHR);
#endif
#if defined(VK_USE_PLATFORM_METAL_EXT)
    WZHU_IF_NAME("vkCreateMetalSurfaceEXT", IMPL_vkCreateMetalSurfaceEXT);
#endif

    WZHU_IF_NAME("vkGetPhysicalDeviceDisplayPropertiesKHR", IMPL_vkGetPhysicalDeviceDisplayPropertiesKHR);
    WZHU_IF_NAME("vkGetPhysicalDeviceDisplayPlanePropertiesKHR",
                 IMPL_vkGetPhysicalDeviceDisplayPlanePropertiesKHR);
    WZHU_IF_NAME("vkGetDisplayModePropertiesKHR", IMPL_vkGetDisplayModePropertiesKHR);
    WZHU_IF_NAME("vkGetDisplayPlaneSupportedDisplaysKHR", IMPL_vkGetDisplayPlaneSupportedDisplaysKHR);
    WZHU_IF_NAME("vkGetDisplayPlaneCapabilitiesKHR", IMPL_vkGetDisplayPlaneCapabilitiesKHR);
    WZHU_IF_NAME("vkCreateDisplayModeKHR", IMPL_vkCreateDisplayModeKHR);
...
#define WZHU_DEV_IF_NAME(name, fn) \
    ...
    WZHU_DEV_IF_NAME("vkGetDeviceProcAddr", IMPL_vkGetDeviceProcAddr);
    WZHU_DEV_IF_NAME("vkDestroyDevice", IMPL_vkDestroyDevice);
    WZHU_DEV_IF_NAME("vkGetDeviceQueue", IMPL_vkGetDeviceQueue);
    WZHU_DEV_IF_NAME("vkGetDeviceQueue2", IMPL_vkGetDeviceQueue2);
    WZHU_DEV_IF_NAME("vkCreateSwapchainKHR", IMPL_vkCreateSwapchainKHR);
    WZHU_DEV_IF_NAME("vkDestroySwapchainKHR", IMPL_vkDestroySwapchainKHR);
    WZHU_DEV_IF_NAME("vkGetSwapchainImagesKHR", IMPL_vkGetSwapchainImagesKHR);
    WZHU_DEV_IF_NAME("vkAcquireNextImageKHR", IMPL_vkAcquireNextImageKHR);
    WZHU_DEV_IF_NAME("vkAcquireNextImage2KHR", IMPL_vkAcquireNextImage2KHR);
    WZHU_DEV_IF_NAME("vkQueuePresentKHR", IMPL_vkQueuePresentKHR);
    WZHU_DEV_IF_NAME("vkQueueSubmit", IMPL_vkQueueSubmit);
    WZHU_DEV_IF_NAME("vkQueueSubmit2", IMPL_vkQueueSubmit2);
    WZHU_DEV_IF_NAME("vkQueueBindSparse", IMPL_vkQueueBindSparse);
...
static VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL IMPL_vkGetPhysicalDeviceProcAddr(VkInstance instance,
                                                                                 const char* pName) {
    return IMPL_vkGetInstanceProcAddr(instance, pName);
}
...
WZHU_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkNegotiateLoaderLayerInterfaceVersion(
    ...
    pVersionStruct->pfnGetInstanceProcAddr = IMPL_vkGetInstanceProcAddr;
    pVersionStruct->pfnGetDeviceProcAddr = IMPL_vkGetDeviceProcAddr;
    pVersionStruct->pfnGetPhysicalDeviceProcAddr = IMPL_vkGetPhysicalDeviceProcAddr;
    return VK_SUCCESS;
}
...
WZHU_LAYER_EXPORT VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetDeviceProcAddr(VkDevice device,
                                                                               const char* pName) {
    return IMPL_vkGetDeviceProcAddr(device, pName);
}
