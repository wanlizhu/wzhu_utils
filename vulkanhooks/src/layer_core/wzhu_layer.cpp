...
extern "C" {
    WZHU_LAYER_EXPORT VKAPI_ATTR VkResult VKAPI_CALL vkNegotiateLoaderLayerInterfaceVersion(
        ...
        version_struct->pfnGetInstanceProcAddr = InterceptGetInstanceProcAddr;
        version_struct->pfnGetDeviceProcAddr = InterceptGetDeviceProcAddr;
        version_struct->pfnGetPhysicalDeviceProcAddr = InterceptGetPhysicalDeviceProcAddr;
        return VK_SUCCESS;
    }
    ...
    WZHU_LAYER_EXPORT VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL vkGetDeviceProcAddr(
        ...
        return InterceptGetDeviceProcAddr(device, name);
    }
